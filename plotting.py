...
def transition_matrix(_figsize, _event_count, _pivot, _transition_count_pivot, _c_index, _filename, _upper_limit=False, _logscale=False):
    ...
    if _upper_limit is not False:
        axis[0][0].set_ylim(top=_upper_limit)
